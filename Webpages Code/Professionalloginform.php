...
<html lang="en">
<head>
  <title>Professional Log in</title>
...
<div id="professionalLog">

  <!-- Blurring the right side -->
  <div class="blur"></div>  

  <div id="professionalLogForm">

    <!-- Professional Login Form -->
    <form class="log-in-form" action="login.inc" method="post">
      ...
      <!-- Login Button -->
      <button class="btn btn-outline-info justify-content-center profLoginSubmitBtn" type="submit" name="profLoginSubmit"> Log-in </button>

      <br>
      <button class="btn btn-outline-info justify-content-center profSubmitBtn" style="margin-left: 1%;" onclick="location.href='Customerloginform'" type="submit" name="profSubmit"> Customer Log-in -> </button>
    </form>

    <!-- Customer Login Button on the Blurry side -->
    <button id="customerbtn" type="button" class="btn btn-outline-info justify-content-center customerLoginBtn"> Customer Log in </button>
</div>
